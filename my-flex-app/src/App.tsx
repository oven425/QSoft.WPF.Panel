...
function App() {
  ...
  return (
    <>
      <div className='w-screen h-screen bg-gray-200 dark:bg-gray-900 dark:text-white flex flex-col'>
        <div className='flex border-b dark:border-gray-700 py-2 justify-between'>
          ...
          <div className='flex pr-4 gap-2'>
            <div className='flex items-end border rounded-sm dark:bg-gray-950 dark:border-gray-700 p-1'>
              <div className={`w-8 rounded-sm ${themeMode==='system'?'bg-gray-800':''}`} onClick={() => setThemeMode('system')}>
              ...
              <div className={`w-8 rounded-sm ${themeMode==='light'?'bg-gray-800':''}`} onClick={() => setThemeMode('light')}>
