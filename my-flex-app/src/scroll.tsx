...
export const ScrollT = () => {
    ...
    return (
        <div className="grid grid-cols-[auto_1fr] grid-rows-[auto_1fr] w-screen h-screen bg-white text-neutral-700 dark:bg-gray-900 dark:text-white">
            <header className="col-span-2 text-white p-4 shadow-md z-10 flex justify-between">
            ...
            <aside className="flex flex-col min-h-0 border-r border-neutral-400 dark:border-gray-700">
                <div className=" w-fit flex flex-col h-full">
                    ...
                    <div className="flex">
                        <div className={`${ss === 'selectContainer' ? 'dark:bg-gray-800 bg-neutral-300' : ''} rounded-sm p-1 grow`} onClick={() => setSS("selectContainer")}>Container</div>
                        <div className={`${item === null ? "invisible" : "visible"} ${ss === 'selectItem' ? 'dark:bg-gray-800 bg-neutral-300' : ''} rounded-sm p-1 grow`} onClick={() => setSS("selectItem")}>Item</div>
                    </div>
                    <div id="setting" className="flex-1 w-80 min-h-0 overflow-y-auto">
