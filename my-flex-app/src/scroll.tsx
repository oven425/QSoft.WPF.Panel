...
export const ScrollT = () => {
    ...
    return (
        <div className="grid grid-cols-[auto_1fr] grid-rows-[auto_1fr] w-screen h-screen bg-white text-neutral-700 dark:bg-gray-900 dark:text-white">
            <header className="col-span-2 bg-slate-800 text-white p-4 shadow-md z-10">
            ...
            <aside className="border-r border-gray-200 flex flex-col min-h-0">
                <div className=" w-fit flex flex-col h-full">
                    ...
                    {/* <div className="w-50 bg-blue-50 border border-blue-200 rounded shrink-0">
                        這是水平超出的內容，這區塊會自動增加寬度。
                    </div> */}
        ...
        //         </div>
        //     </header>
        //     <div className="flex flex-row justify-start items-stretch min-h-0">
        ...
        //             <div className="overflow-y-auto self-">
        //                 <ContainerSetting className={''} containerSetting={containerSetting} setContainerSetting={setContainerSetting} />
        //             </div>
        //         </aside>
        //         <div className={`p-1 flex ${containerSetting.direction == 'flex-row' ? 'flex-row' : 'flex-col'} ${containerSetting.isShowScrollbar === true ? 'overflow-auto' : ''}  min-w-0`}>
